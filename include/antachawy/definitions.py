...
simbolos_compuestos = {
    ...
    "<=": EtiquetasAntachawy.OPERADOR_RACIONAL,
    ">=": EtiquetasAntachawy.OPERADOR_RACIONAL,
    "//": EtiquetasAntachawy.OPERADOR_ARITMETICO
}
...
primeros = {
    ...
    "ListaCondiciones": [LexemasAntachawy.ARI],
    "Condiciones": [
        LexemasAntachawy.ARI,
        LexemasAntachawy.IMAPAQ,
        LexemasAntachawy.CHAYKAMA
...
producciones = {
    ...
    "CicloFor": [LexemasAntachawy.IMAPAQ, LexemasAntachawy.PAREN_IZQ, "Declaracion", LexemasAntachawy.PUNTOYCOMA, "Condicion", LexemasAntachawy.PUNTOYCOMA, "Operacion", LexemasAntachawy.PAREN_DER, LexemasAntachawy.LLAVE_IZQ, "Bloque", LexemasAntachawy.LLAVE_DER],
    "CicloWhile": [LexemasAntachawy.CHAYKAMA, LexemasAntachawy.PAREN_IZQ, "Condicion", LexemasAntachawy.PAREN_DER, LexemasAntachawy.LLAVE_IZQ, "Bloque", LexemasAntachawy.LLAVE_DER],
    "CondicionesElseif": [
    ...
    "Operacion": [
        [LexemasAntachawy.ID, LexemasAntachawy.ASIGNA, LexemasAntachawy.ID, "Operador", LexemasAntachawy.ID],
        [LexemasAntachawy.ID, LexemasAntachawy.ASIGNA, LexemasAntachawy.NUMERO, "Operador", LexemasAntachawy.ID],
        [LexemasAntachawy.ID, LexemasAntachawy.ASIGNA, LexemasAntachawy.ID, "Operador", LexemasAntachawy.NUMERO],
        [LexemasAntachawy.ID, LexemasAntachawy.ASIGNA, LexemasAntachawy.NUMERO, "Operador", LexemasAntachawy.NUMERO]],
    ...
    "Operador": [
        ...
        [LexemasAntachawy.MULTIPLICA],
        [LexemasAntachawy.DIVIDE],
        [LexemasAntachawy.DIVISIONEXACTA]
    ],
    "OperadorRelacional": [
        [LexemasAntachawy.MAYOR],
        [LexemasAntachawy.MENOR],
